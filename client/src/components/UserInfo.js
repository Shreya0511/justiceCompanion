      ...
      <Card.Body style={{ paddingRight: "4rem" }}>
        ...
        <Stack gap={3}>
          ...
          >
            ...
            <div
              style={{ border: "0.01rem solid gray", marginRight: "1rem" }}
            ></div>
          </div>
          ...
          >
            ...
            >
              <div style={{ color: "whitesmoke", fontSize: "1rem", flex: "9" }}>
                {showPassword
                  ? JSON.parse(user.user).passwordConfirm
                  : "********"}
              </div>
              <div style={{ flex: "1" }}>
                <FontAwesomeIcon
            ...
            <div style={{ border: "0.01rem solid gray", marginRight: "1rem" }}>
